                ...
                <tbody>
                    ...
                    <?php foreach ($subMenu as $sm) : ?>
                        <tr>
                            ...
                            <td><?= $sm['is_active']; ?></td>
                            <td>
                                <button href="" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" data-target="#exampleModalsubedit<?= $sm['id'] ?>" data-placement="top" title="edit">Edit</button>
                                <!-- <button onclick="hapusSubmenu('<?= base_url('menu/hapus/') . $sm['id'] ?>')" class="btn btn-danger btn-sm tombol-hapus">Delete</button> -->
                                <button onclick="hapusMenu('<?= base_url('menu/hapus/') . $sm['id'] ?>')" class="btn btn-danger btn-sm tombol-hapus">Delete</button>
                            </td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
