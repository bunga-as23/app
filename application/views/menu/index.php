                ...
                <tbody>
                    ...
                    <?php foreach ($menu as $m) : ?>
                        <tr>
                            ...
                            <td><?= $m['menu']; ?></td>
                            <td>
                                <button href="" class="btn btn-success btn-sm" data-toggle="modal" data-popup="tooltip" data-placement="top" 0data-target="#exampleModalmenuedit<?= $m['id'] ?>" data-placement="top" title="edit">Edit</button>
