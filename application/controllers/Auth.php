...
class Auth extends CI_Controller
{
    ...
    //     $config['smtp_user'] = 'bngaadndasr@gmail.com'; // isi dgn email
    //     $config['smtp_pass'] = 'jggudgmleabspmpq'; // password harus sesuai
    //     $config['smtp_port'] = '465';
    //     $config['mailtype'] = 'html';
    //     $config['charset'] = 'utf-8';
    //     $config['newline'] = "\r\n";
    //     $this->email->initialize($config);
    //     $this->email->from('bngaadndasr@gmail.com', 'Bunga Adinda Sari');
    ...
    private function _sendEmail($token, $type)
    {
        ...
        $config = [
            ...
            'smtp_user' => 'bngaadndasr@gmail.com',
            'smtp_pass' => 'jggudgmleabspmpq',
            'smtp_port' => '465',
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n",
